/*
 * This file consists of functions which over a period of time checks for any updations and 
 * then transfer those files/dirs to remote with help of rsync, for SNAPSync.
 *
