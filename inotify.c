/*
 * The function inotify_main() will be called by the main() defined in user_sync.c, for SNAPSync.
 * inotify_main() will be called in a thread. This functions will give the notifications related 
 * to the filesystem events for eg- creating file, deleting file, etc. 
 * 	
